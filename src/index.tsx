...
import { CarsCopy } from './pages/cars/CarsCopy';
    ...
    createRoutesFromElements(
        <Route>
            <Route path="/" element={<Layout />}>
                ...
                <Route path="cars_copy">
                    <Route index element={<CarsCopy />} />
                    <Route path=":brand" element={<CarsCopy />} />
                    <Route path=":brand/:model" element={<CarsCopy />} />
                    <Route path=":brand/:model/:generation" element={<CarsCopy />} />
                </Route>
