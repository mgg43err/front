...
export const ModalReport = () => {
    ...
    if (!car?.history_cars || car.history_cars.length === 0) {
        return <div>Нет данных о истории автомобиля</div>;
    }

    const vinValue = car.history_cars[0]?.vin || null;
    const transformedVin = vinTransform(vinValue);
                        ...
                        <li className={styles.modal_report__content_item}>
                            ...
                            <ul className={styles.modal_report__characters}>
                                <li className={styles.modal_report__characters_item}>
                                    VIN: <span>{transformedVin || 'Нет данных'}</span>
                                </li>
                                <li className={styles.modal_report__characters_item}>
                                    № кузова: <span>{transformedVin || 'Нет данных'}</span>
                                </li>
                                <li className={styles.modal_report__characters_item}>
